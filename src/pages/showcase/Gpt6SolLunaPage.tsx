...
import { getSolLunaCopy, solLunaModel } from "@/data/model-pages/gpt-6-sol-luna";

export default function Gpt6SolLunaPage() {
  const { t } = useTranslation();
  return <ModelDetailPage model={solLunaModel} copy={getSolLunaCopy(t)} collection={gpt6SolLunaCollection} />;
}
