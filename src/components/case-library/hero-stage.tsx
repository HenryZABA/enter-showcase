...
export const HeroStage = memo(function HeroStage({ content, collectionHref, blended = false, compact = false }: HeroStageProps) {
  const { t } = useTranslation();

  return (
    <section className={`ambient-section relative isolate overflow-hidden ${blended ? "showcase-hero-blended" : "border-b border-border/60"} ${compact ? "showcase-hero-compact" : ""}`}>
      ...
      <div className="showcase-hero-content container flex min-h-[320px] items-center justify-center py-10 sm:py-12 lg:py-14">
